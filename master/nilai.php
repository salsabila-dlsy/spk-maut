							...
							<tbody>
								...
								?>
									...
									<tr>
										...
										?>
										<td>
											<a href="?page=nilai&act=ubah&id_penduduk=<?php echo $r2['id_penduduk']; ?>" class="btn btn-info">
									...
									<form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
										...
										while ($r22 = mysqli_fetch_array($tampil22)) {
											if ($r22['kode_bobot'] == $r['kode_bobot']) {
												echo "<option value=$r22[kode_bobot] selected>";
												if ($r22['n_bobot'] == 2) {
													echo "Lebih dari atau Sama dengan $r22[b_nama]";
												} else {
													echo "$r22[b_nama]";
												}
											} else {
												echo "<option value=$r22[kode_bobot]>";
												if ($r22['n_bobot'] == 2) {
													echo "Lebih dari atau Sama dengan $r22[b_nama]";
												} else {
													echo "$r22[b_nama]";
